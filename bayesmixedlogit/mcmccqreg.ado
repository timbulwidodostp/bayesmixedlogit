...
*! version 1.0.1 16April2014
*! Edited to fix the standard error problem and need to multiply by N
...
/* Whlie doing censor checking retain N for use with standard errors */

	tempvar N
	scalar `N'=r(N)
	mata: N=st_numscalar("`N'")

/* Done and start the censor checking now */	
	...
	mata: st_matrix("`V'",N*variance(betaf))	/* Now multiplied by the appropriate scaling factor 16April2014 */
